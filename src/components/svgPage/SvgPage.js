...
const svgContainer = {
  ...
  focus: { scale: 1.5, backgroundColor: 'var(--transparent)' },
  selected: { scale: 1.2, backgroundColor: 'var(--light-background)' },
};
...
const SymbolSvg = () => {
  ...
  return (
    <motion.div className={styles.symbolContainer} variants={symbolContainer}>
      <motion.div
